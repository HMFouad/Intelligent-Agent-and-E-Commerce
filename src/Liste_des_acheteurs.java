 ...
 * @author  compaq
 */
public class Liste_des_acheteurs extends javax.swing.JFrame {

private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
setVisible(false);        // TODO add your handling code here:
    }
    /** Creates new form bd */
    public Liste_des_acheteurs() { 
...
tabletest.setModel(new javax.swing.table.DefaultTableModel(
        ...
        jLabel1.setText("                La liste des acheteurs");
    ...
    catch(Exception e)
    {
     ...
     private void affichertest() {
             try
                {
                 dt.getRowCount();
                 rsl = stm.executeQuery("Select * From Liste_acheteurs ") ;
                 while (rsl.next() )
                         {
                             Id = rsl.getInt("Id");
                             Nom_acheteur = rsl.getString("Nom_acheteur");
                             Sexe = rsl.getString("Sexe");
                             Object[] tst = {Id,Nom_acheteur,Sexe};
                             dt.addRow(tst);
                         }
                         tabletest.setModel(dt);
                }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Liste_des_acheteurs().setVisible(true);
...
private javax.swing.JButton jButton1;
    ...
    private String Nom_acheteur,Sexe;
